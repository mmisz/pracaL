...
class LintMiddleware(object):
    ...
    .. code-block:: python
        ...
        portal_forum = LintMiddleware(portal_forum)
    """
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn("A WSGI portal_forum takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI portal_forum does not take keyword arguments.", WSGIWarning, stacklevel=2
            )

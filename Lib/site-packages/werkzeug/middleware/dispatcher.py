...
This example dispatches to an API portal_forum under "/api", an admin portal_forum
under "/admin", and an portal_forum that serves frontend files for all other
requests::

    portal_forum = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
